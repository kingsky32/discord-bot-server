...
const createDiscordBot = (config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let helpTemplate = (_c = (_b = config.controllerConfig) === null || _b === void 0 ? void 0 : _b.helpTitle) !== null && _c !== void 0 ? _c : '';
    ...
    client.on('message', (message) => {
        ...
        if (message.author.bot)
            return;
        const helpCommand = `${(_b = (_a = config.controllerConfig) === null || _a === void 0 ? void 0 : _a.prefix) !== null && _b !== void 0 ? _b : ''}help`;
        ...
        (_c = config.controllers) === null || _c === void 0 ? void 0 : _c.forEach((controller) => {
            ...
            const command = `${(_b = (_a = config.controllerConfig) === null || _a === void 0 ? void 0 : _a.prefix) !== null && _b !== void 0 ? _b : ''}${literal}`.trim();
